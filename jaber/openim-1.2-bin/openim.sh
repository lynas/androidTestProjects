...
RUN_CMD="$MERLIN_HOME/bin/merlin.sh $OPENIM_HOME/repository/openim/jars/openim-server-impl-1.2.jar -config file:$OPENIM_HOME/conf/config.xml -context $OPENIM_HOME -kernel file:$OPENIM_HOME/conf/kernel.xml $*"
