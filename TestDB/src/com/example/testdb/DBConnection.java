...
public class DBConnection {
    ...
    /*
     * This method sending the list containing all the number in the user phone and
     * receive only those number available in the db
     * 
     */
    public String getInfoFromDB(String givenList) {
  
        httpclient = new DefaultHttpClient();
        httpPost = new HttpPost("http://10.0.2.2/getExitingUserAndAddInFriendList.php?list="+givenList);
        try {
